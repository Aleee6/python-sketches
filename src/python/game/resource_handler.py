import pygame
from python.game.settings import RESOURCES, WINDOW_SIZE, SHIP_RESOURCES, \
    SHIP_SIZE, BEAM_RESOURCES, BULLET_SIZE, EXPLOSION_RESOURCES, EXPLOSION_SIZE, SOUND_RESOURCES
